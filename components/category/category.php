...
$image_id = get_term_meta($category_id, 'category_image', true);
$image_url = $image_id ? wp_get_attachment_image_url($image_id, 'full') : '';
?>
<div id="main-eya-catch-area" class="main-eya-catch-area <?php if (!$image_url): ?>no-eye-catch<?php endif ?>">
    <div class="main-eye-catch-area-content">
        <h2 class="main-title"><?php echo esc_html($category->name); ?></h2>
        <p class="main-description"><?php echo esc_html($category->description); ?></p>
    </div>
    <?php if ($image_url): ?>
